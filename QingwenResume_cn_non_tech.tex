...
\begin{document}
	...
	\begin{itemize}
		\item 带队员去其他省市参加比赛，负责安排团队行程。
		\item 游走于学校的各个部门，完成出国参赛的相关流程手续。
%		\item 负责维护ACM校队服务器和实验室网站的搭建。
	...
	\end{itemize}
%    \item
%	\ressubheadingsingleline{学生会~学习生活部副部长}{2009 - 2011}
    \end{itemize}
	...
	\begin{itemize}
		...
		\item \ressubheadingsingleline{校级三国杀3v3比赛第三名}{2013}
	\end{itemize}
	...
	\item 热爱运动, 坚持骑自行车上下班，坚持每两天去一次健身房。
