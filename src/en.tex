...
\begin{itemize} \setlength{\itemsep}{0pt}
	\item
		\resitem{Google UK Ltd - Software Engineering}{Nov.2015 - Jan.2016 (3 mos)}
		\vspace{-5pt} \begin{itemize} \setlength{\itemsep}{0pt}
		    \item I was working on the UI part of Google Now.
		\end{itemize} \vspace{-5pt}
	\item
		\resitem{Bytedance Inc - Software Engineering}{July.2015 - Oct.2015 (4 mos)}
	\item
		\resitem{Microsoft Research Asia - Research Engineering Intern}{Aug.2013 - June.2015 (2 yrs)}
\end{itemize}
